  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 20px hsl(var(--primary) / 0.4)" }, "50%": { boxShadow: "0 0 60px hsl(var(--primary) / 0.7)" } },
      ...
      animation: {
        ...
        "slide-in-right": "slide-in-right 0.7s cubic-bezier(0.22, 1, 0.36, 1)",
